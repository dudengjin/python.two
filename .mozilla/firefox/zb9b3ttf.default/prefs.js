...
user_pref("browser.laterrun.bookkeeping.profileCreationTime", 1514425024);
user_pref("browser.laterrun.bookkeeping.sessionCount", 1);
user_pref("browser.laterrun.enabled", true);
user_pref("browser.migration.version", 59);
user_pref("browser.newtabpage.activity-stream.migrationLastShownDate", 1514390400);
...
user_pref("browser.slowStartup.averageTime", 2362);
...
user_pref("e10s.rollout.cohortSample", "0.190008");
user_pref("e10s.rollout.cohortSample.multi", "0.319904");
...
user_pref("extensions.webextensions.uuids", "{\"screenshots@mozilla.org\":\"523172a5-0c59-4f3a-86e3-bfe16b3352ea\"}");
...
user_pref("toolkit.startup.last_success", 1514425023);
user_pref("toolkit.telemetry.cachedClientID", "9acc9fd5-2837-488a-aa3f-661465481fd9");
